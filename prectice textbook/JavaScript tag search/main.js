...
const tags = {
  ...
  acronym:
    "Не поддерживается в HTML5. Использовать embed or object Вместо.Определяет встроенный апплет",
  ...
  basefont:
    "Не поддерживается в HTML5. Вместо этого используйте CSS.Задает цвет, размер и шрифт по умолчанию для всего текста в документе",
  ...
  h1: "Определяет заголовки HTML",
  h2: "Определяет заголовки HTML",
  h3: "Определяет заголовки HTML",
  h4: "Определяет заголовки HTML",
  h5: "Определяет заголовки HTML",
  h6: "Определяет заголовки HTML",
  ...
  noframes:
    "Не поддерживается в HTML5. Определяет альтернативное содержимое для пользователей, которые не поддерживают кадры",
  noscript:
  ...
  strike:
    "Не поддерживается в HTML5. Использовать del или s Вместо. Определяет текст зачеркивания",
...
const tagSearchInput = document.querySelector(".tagSearch__input");
const tagSearchBtn = document.querySelector(".tagSearch__btn");
const tagSearchParagraph = document.querySelector(".tagSearch__paragrapgh");
tagSearchBtn.addEventListener("click", result);

function result() {
  tagSearchParagraph.textContent = tags[tagSearchInput.value];
}
